...
export default async function LibraryPage({
  ...
  searchParams: Promise<{ page?: string, title?: string, authors?: string, subjects?: string }>;
}) {
  ...
  const result = await fetchBooksPaginated({ page: page, title: title, authors: authors, subjects: subjects });
  ...
  return <Library books={books} authors={sortedAuthors} subjects={sortedSubjects} page={page} pageCount={pageCount} />;
}
